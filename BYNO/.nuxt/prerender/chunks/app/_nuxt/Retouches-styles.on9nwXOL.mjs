...
import 'file://C:/Users/Anna/Documents/projets-web/BYNO/BYNO/node_modules/vue/server-renderer/index.mjs';
...
import 'file://C:/Users/Anna/Documents/projets-web/BYNO/BYNO/node_modules/vue/index.mjs';
...
const Retouches_vue_vue_type_style_index_0_scoped_ef7f7998_lang = ".retouches[data-v-ef7f7998]{align-items:center;display:flex;flex-direction:column;justify-content:center;padding-top:5rem}h3[data-v-ef7f7998]{font-family:mpluslight;font-size:2rem;margin-bottom:7rem;text-align:center}.img1[data-v-ef7f7998]{background-image:url(" + publicAssetsURL("img/retouches-img1.JPG") + ");background-repeat:no-repeat;background-size:100% 100%;border-radius:4px;height:85vh;margin-bottom:3rem;width:75%}.bloc-img-text[data-v-ef7f7998]{align-items:center;display:flex;justify-content:center;margin-bottom:3rem;width:80%}.img2[data-v-ef7f7998]{background-image:url(" + publicAssetsURL("img/retouches-img2.jpeg") + ");background-position:50%;background-repeat:no-repeat;background-size:contain;border-radius:4px;height:85vh;margin:2rem;width:60vw}h4[data-v-ef7f7998]{font-family:mpluslight;font-size:1.3rem;margin-bottom:4rem;text-align:center;width:80%}@media (min-width:821px) and (max-width:1050px){.img1[data-v-ef7f7998]{height:50vh}.img2[data-v-ef7f7998]{height:55vh}.bloc-img-text[data-v-ef7f7998]{margin-bottom:0}}@media screen and (max-width:820px){h3[data-v-ef7f7998]{font-size:1.5rem;margin:4rem}.img1[data-v-ef7f7998]{height:40vh;width:100%}.bloc-img-text[data-v-ef7f7998]{flex-direction:column-reverse;margin-bottom:0;width:100%}h4[data-v-ef7f7998]{font-size:1.5rem}.img2[data-v-ef7f7998]{height:50vh;width:100%}}";

const RetouchesStyles_on9nwXOL = [Retouches_vue_vue_type_style_index_0_scoped_ef7f7998_lang];

export { RetouchesStyles_on9nwXOL as default };
//# sourceMappingURL=Retouches-styles.on9nwXOL.mjs.map
