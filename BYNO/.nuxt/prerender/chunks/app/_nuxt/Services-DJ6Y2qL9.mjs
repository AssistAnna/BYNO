...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrInterpolate } from 'file://C:/Users/Anna/Documents/Projets%20webs/BYNO/BYNO/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "all" }, _attrs))} data-v-750117d9><div class="cards-bloc" data-v-750117d9><!--[-->`);
  ssrRenderList($data.cards, (card, key) => {
    _push(`<div class="card box-shadow" data-v-750117d9><div class="card-icon" style="${ssrRenderStyle(" background-image: url(" + card.iconUrl + ")")}" data-v-750117d9></div><div class="liste-text" data-v-750117d9><p data-v-750117d9>${ssrInterpolate(card.text1)}</p><p data-v-750117d9>${ssrInterpolate(card.text2)}</p><p data-v-750117d9>${ssrInterpolate(card.text3)}</p><p data-v-750117d9>${ssrInterpolate(card.text4)}</p></div></div>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-750117d9"]]);
const _sfc_main = {};
...
//# sourceMappingURL=Services-DJ6Y2qL9.mjs.map
