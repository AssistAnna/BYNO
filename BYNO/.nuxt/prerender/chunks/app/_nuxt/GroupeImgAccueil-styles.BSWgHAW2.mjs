...
import 'file://C:/Users/Anna/Documents/Projets%20webs/BYNO/BYNO/node_modules/vue/server-renderer/index.mjs';
...
import 'file://C:/Users/Anna/Documents/Projets%20webs/BYNO/BYNO/node_modules/vue/index.mjs';
...
const GroupeImgAccueil_vue_vue_type_style_index_0_scoped_45193003_lang = ".groupe-img-accueil[data-v-45193003]{background-image:url(" + buildAssetsURL("background.DNdY0zhZ.jpg") + ");background-position:50%;background-repeat:no-repeat;background-size:100%;height:80vh;position:relative;width:100%}.frame[data-v-45193003],.logo[data-v-45193003]{height:100%;width:100%}.logo[data-v-45193003]{align-items:center;display:flex;justify-content:center;position:absolute;top:0}.logo-ecriture[data-v-45193003]{height:45vh;width:20vw}@media (min-width:820px) and (max-width:1050px){.groupe-img-accueil[data-v-45193003]{height:35vh}.logo-ecriture[data-v-45193003]{height:18vh}}@media screen and (max-width:819px){.groupe-img-accueil[data-v-45193003]{height:29vh}.logo-ecriture[data-v-45193003]{height:12vh}}";

const GroupeImgAccueilStyles_BSWgHAW2 = [GroupeImgAccueil_vue_vue_type_style_index_0_scoped_45193003_lang];

export { GroupeImgAccueilStyles_BSWgHAW2 as default };
//# sourceMappingURL=GroupeImgAccueil-styles.BSWgHAW2.mjs.map
