...
import { ssrRenderAttrs } from 'file://C:/Users/Anna/Documents/projets-web/BYNO/BYNO/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "apropos" }, _attrs))} data-v-7d3500f5><h2 class="title-h2" data-aos="fade-up" data-v-7d3500f5>A propos</h2><div class="bloc-img1" data-aos="zoom-in" data-v-7d3500f5><div class="img1" data-v-7d3500f5></div></div><div class="bloc-text" data-aos="fade-up" data-v-7d3500f5><h3 data-v-7d3500f5>No\xE9 Chardon</h3><h4 data-v-7d3500f5>entrepreneur passionn\xE9</h4><p data-v-7d3500f5>Passionn\xE9 par la musique et la vid\xE9o, mon objectif est de vous guider dans la conception de votre identit\xE9 visuelle et dans le d\xE9ploiement de votre communication sur les r\xE9seaux sociaux. Chaque projet que je r\xE9alise est con\xE7u pour vous satisfaire et vous accompagner dans votre d\xE9veloppement.</p></div></div>`);
}
...
//# sourceMappingURL=Apropos-BCvaLUW1.mjs.map
