...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/Anna/Documents/Projets%20webs/BYNO/BYNO/node_modules/ufo/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\Anna\\Documents\\Projets webs\\BYNO\\BYNO\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _k3Euj4rraK = (function(nitro) {
...
const _lazy_AKWQn3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_AKWQn3, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file://C:/Users/Anna/Documents/Projets%20webs/BYNO/BYNO/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/Anna/Documents/Projets%20webs/BYNO/BYNO/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
