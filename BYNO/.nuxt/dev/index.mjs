...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/Anna/Documents/projets-web/BYNO/BYNO/node_modules/ufo/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\Anna\\Documents\\projets-web\\BYNO\\BYNO\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _MxlhDZ9BPm = (function(nitro) {
...
const _lazy_EzEq7V = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_EzEq7V, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file://C:/Users/Anna/Documents/projets-web/BYNO/BYNO/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/Anna/Documents/projets-web/BYNO/BYNO/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
